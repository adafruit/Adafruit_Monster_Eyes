 ...
 *
 * Adapted from Adafruit's flash_config.h. Assets live on a FAT volume in the
 * board's flash, read through Adafruit_SPIFlash + SdFat; which region that is
 * depends on the chip.
 */

#ifndef FLASH_CONFIG_H_
#define FLASH_CONFIG_H_ ///< Include guard
...
#else
Adafruit_FlashTransport_RP2040 flashTransport; ///< Asset flash
#endif
...
Adafruit_FlashTransport_ESP32 flashTransport; ///< Asset flash

// ---------------------------------------------------------------------------
#elif defined(EXTERNAL_FLASH_USE_QSPI)
// ---------------------------------------------------------------------------
Adafruit_FlashTransport_QSPI flashTransport; ///< Asset flash

#elif defined(EXTERNAL_FLASH_USE_SPI)
Adafruit_FlashTransport_SPI
    flashTransport(EXTERNAL_FLASH_USE_CS,
                   EXTERNAL_FLASH_USE_SPI); ///< Asset flash
